...
BONES_BASE: List[Bone] = [
    ...
    ("thigh_L",   0, (0.09, -0.02, 0.0), (0.0, -0.44, 0.0),  0.085),
    ("shin_L",   13, (0.0, -0.44, 0.0),  (0.0, -0.42, 0.0),  0.06),
    ("foot_L",   14, (0.0, -0.42, 0.0),  (0.0, -0.05, 0.19), 0.05),

    ("thigh_R",   0, (-0.09, -0.02, 0.0),(0.0, -0.44, 0.0),  0.085),
    ("shin_R",   16, (0.0, -0.44, 0.0),  (0.0, -0.42, 0.0),  0.06),
